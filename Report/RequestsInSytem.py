...
def pull_data() -> None:
    ...
    for dataset in datasets:
        ax = axs[loc]
        # ax.plot(dataset[2]["Time"], dataset[2]["Value"], "red",label="Not Computed")
        # ax.plot(dataset[3]["Time"], dataset[3]["Value"], "green", label="Waiting")
        ...
        ax.plot(dataset[1]["Time"], dataset[1]["Value"], "blue", label="Total")
        # ax.scatter(x=dataset[1]["Time"], y=dataset[1]["Value"], color="blue")
