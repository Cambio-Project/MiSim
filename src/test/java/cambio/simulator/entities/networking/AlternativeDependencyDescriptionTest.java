...
public class AlternativeDependencyDescriptionTest extends AbstractDependencyDescriptionTest {
	...
	private AlternativeDependencyDescription setupAlternativeDependencyWithTwoChildren(
		...
		final SimpleDependencyDescription child1 = spy(new SimpleDependencyDescription(startOperation, operation1,
				operation1Probability, 0.0, operation1AlternativeProbability));
		final SimpleDependencyDescription child2 = spy(new SimpleDependencyDescription(startOperation, operation2,
				operation2Probability, 0.0, operation2AlternativeProbability));
