...
public class LoopDependencyDescriptionTest extends AbstractDependencyDescriptionTest {
    ...
    /**
     * Fills the alternative dependency with two (mocked) children.
     *
    ...
    private LoopDependencyDescription setupLoopDependencyWithOneChild(LoopDependencyDescription dependency,
        ...
        final SimpleDependencyDescription child =
            spy(new SimpleDependencyDescription(startOperation, operation, operationProbability, 0.0, 1.0));
        this.childDescription = child;
        final ServiceDependencyInstance childInstance = mock(ServiceDependencyInstance.class);
