...
/**
 * This class extends the <code>desmoj.core.simulator.ProcessQueue&lt;P&gt;</code> with spatial functionalities. Every
 * SpatialProcessQueue is associated with a spatial position and orientation.
 *
 * @author Fred Sun
 */
public class SpatialProcessQueue<P extends SimProcess> extends ProcessQueue<P> implements
    ...
    /**
     * Constructs a SpatialProcessQueue at the specific position. Beside of the spatial extension the behaviors and the
     * functionalities of the SpatialProcessQueue remain the same as the ProcessQueue. For more information about the
     * ProcessQueue, and the constructor, please see
     ...
     * @param qCapacity    The capacity of the ProcessQueue, that is how many processes can be enqueued. Zero (0) means
     *                     unlimited capacity.
     * @param showInReport Flag if process-queue should produce a report.
     * @param showInTrace  Flag for process-queue to produce trace messages.
     */
