...
/**
 * This class represents the DESMO-J Entities which should be visualized but not movable in the 3D space. It implements
 * the SpatialObject interface to handle with the 3D spatial data.
 *
 * @author Fred Sun
 */
