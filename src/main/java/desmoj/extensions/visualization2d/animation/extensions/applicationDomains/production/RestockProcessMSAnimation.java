...
/**
 * Animation of RestockProcessMS. After instantiation you must execute methods from superclass:<br> createAnimation(...)
    ...
    private void check(RestockProcessMS restock) {
        if (!(restock.getModel() instanceof ModelAnimation)) {
            throw new SimulationException(
                "For animation, RestockProcessMS must be initialized with a model of type ModelAnimation");
        }
    }
}