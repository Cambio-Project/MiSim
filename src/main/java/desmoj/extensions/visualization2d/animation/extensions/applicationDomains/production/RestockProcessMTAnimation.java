...
/**
 * Animation of RestockProcessMT. After instantiation you must execute methods from superclass:<br> createAnimation(...)
    ...
    private void check(RestockProcessMT restock) {
        if (!(restock.getModel() instanceof ModelAnimation)) {
            throw new SimulationException(
                "For animation, RestockProcessMT must be initialized with a model of type ModelAnimation");
        }
    }
