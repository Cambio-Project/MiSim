...
/**
 * Animation of an Entity. Free and static entities are supported. Free Entities can be included in Containers, as
 * Queues, Processes, ect. and have no fixed location. Static Entities have a fixed location and can not be included in
...
public class EntityAnimation extends Entity implements EntityBasicAnimation {
    ...
    /**
     * createAnimation method of free entities. These are non static entities and can be included in Containers, such as
    ...
    /**
     * Set attributes Following signs in the key are not valid :,:| they are changed to _
     *
