...
/**
 * TODO:!!!!!! Adapter for parsing distributions from JSON into a {@link NumericalDist}.
 *
 * <p>
 ...
 */
public class DiscreteDistributionAdapter
        extends MiSimModelReferencingTypeAdapter<NumericalDist<Integer>> {
        ...
        if (peeked == JsonToken.STRING) {
            ...
            try {
                ...
                throw new ParsingException(String.format(
                        "Could not parse distribution expression \"%s\". It must be an integer value.",
                        untrimmedValue), e);
            }
