...
/**
 * RuntimeException that represents the stopping of a generator. Can be used by the subclasses of {@code Generator} to
 * stop itself from rescheduling.
 *
 * @author Lion Wagner
 * @see Generator
 */
public class GeneratorStopException extends RuntimeException {
     ...
     *                method.
     */
    public GeneratorStopException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public GeneratorStopException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * useful for runtime exceptions that are little more than wrappers for other throwable.
     *
     * @param cause the cause (which is saved for later retrieval by the {@link #getCause()} method).  (A {@code null}
     *              value is permitted, and indicates that the cause is nonexistent or unknown.)
     * @since 1.4
     */
    public GeneratorStopException(Throwable cause) {
        super(cause);
    }
     ...
     * @since 1.7
     */
    public GeneratorStopException(String message, Throwable cause, boolean enableSuppression,
