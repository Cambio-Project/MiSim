...
public class LoadGeneratorStopException extends Exception {
     ...
     */
    public LoadGeneratorStopException() {
    }
     ...
     *                method.
     */
    public LoadGeneratorStopException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public LoadGeneratorStopException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public LoadGeneratorStopException(Throwable cause) {
        super(cause);
    }
