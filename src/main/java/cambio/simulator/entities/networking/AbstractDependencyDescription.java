...
/**
 * An abstract implementation of {@link DependencyDescription} taking care of
 * the probabilities and alternative probabilities.
 * 
...
public abstract class AbstractDependencyDescription implements DependencyDescription {
	 ...
	 * {@link #probability}. Note that this operation can provide different results
	 * when calling it multiple times since it is random.
	 * 
