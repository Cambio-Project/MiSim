...
/**
 * The <code>DependencyGraph</code> class is used in order to create the graph
 * that displays the dependencies between the systems' microservice instances.
 */
public class DependencyGraph {
	...
	private String printNodes() {
		...
		for (Microservice ms : microservices) {
			...
			int instanceLimit = !model.getExperimentMetaData().getReportType().equals("minimalistic")
