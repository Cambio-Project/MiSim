...
public interface IRequestUpdateListener {
     ...
     */
    default void onRequestFailed(Request request) {
    }
     ...
     * request.
     */
    default void onRequestArrivalAtTarget(Request request) {
    }
     ...
     */
    default void onRequestResultArrivedAtRequester(Request request) {
